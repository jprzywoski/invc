...
# This target requires 'slin', 'infer', 'flawfinder' and 'cppcheck' tools on 
# your PATH.
...
ifeq ($(TARGET), $(DEVEL))
	...
	CFLAGS += -fno-optimize-sibling-calls -fasynchronous-unwind-tables -fexceptions
	# code hardening
    CPPFLAGS += -D_FORTIFY_SOURCE=2 -D_GLIBCC_ASSERTIONS
